...
public class TestEnumeration {
    ...
    public void testEnumerationHorizontal() {
        int cellsNumber = 3;
        List<Pair<Integer, Integer>> cellUsed = new ArrayList<Pair<Integer, Integer>>();
        ...
        List<Pair<Integer, Integer>> cellUsedOrientation1 = orientation1.cellsUsedList(new Pair<Integer, Integer>(0, 0), cellsNumber);
